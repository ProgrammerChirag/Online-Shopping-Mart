...
public class ActivityChooseAddress extends AppCompatActivity {
    ...
    ValueEventListener listener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            ...
            {
                slider.setAdapter( new ShowAddressAdapter(ActivityChooseAddress.this , deliveryAddresses));
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        AddAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityChooseAddress.this , TakingAddressActivity.class);
        ...
        setPayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (deliveryAddresses != null) {
                    ...
                    Intent intent = new Intent(ActivityChooseAddress.this, PaymentPage.class);
    ...
    private void fetchData() {
        String user;
        user = new SettingMemoryData(ActivityChooseAddress.this).getSharedPrefString(String.valueOf(R.string.USERNAME_KEY));
        ...
        if (requestCode == 1234)
        {
            if (data !=null) {
                ...
                if (Address != null && name != null && Phone != null) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(ActivityChooseAddress.this);
                    ...
                    builder.setPositiveButton("Add address", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            uploadData(deliveryAddress , new SettingMemoryData(ActivityChooseAddress.this)
